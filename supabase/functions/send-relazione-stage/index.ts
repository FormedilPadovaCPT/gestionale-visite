...
/* ⚠️ CHI PUO' CHIAMARLA (14/09/2026). verify_jwt=true lasciava passare la
   ...
   chiunque poteva far partire dalla casella dell'ente una mail con allegato
   verso un indirizzo scelto da lui. Ora serve un utente autenticato del
   personale (is_personale). Il ruolo lo dice il database, eseguito COME
   l'utente: con la sola anon risponde errore = «no». */
